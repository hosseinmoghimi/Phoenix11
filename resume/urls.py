...
urlpatterns = [
    ...
    path("resume/<int:person_id>/",(views.ResumeIndexView.as_view()),name="profile_resume_index"),
    ...
    path('<int:person_id>/<language_code>/',views.ResumeIndexView.as_view(),name="resume_index_language"),
