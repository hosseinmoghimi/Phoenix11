...
phoenix_apps=[
    ...
    {'priority':8,'name':'messenger','url':SITE_URL+'messenger/','title':'پیام رسان','logo':STATIC_URL+'messenger'+'/img/'+'logo.png','color':'success',},
    ...
    {'priority':10,'name':'transport','url':SITE_URL+'transport/','title':'حمل و نقل','logo':STATIC_URL+'transport'+'/img/'+'logo.png','color':'danger',},
